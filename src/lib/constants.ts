...
export const QUICK_SCORE_VALUES = [26, 41, 45, 60, 81, 85, 100, 121, 140, 180, REM_SENTINEL, 0]
export const QUICK_SCORE_LABELS = ['26', '41', '45', '60', '81', '85', '100', '121', '140', '180', '→ rem', 'Miss']
